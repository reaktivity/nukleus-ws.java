...
public class WsOptionsAdapterTest
{
    private Jsonb jsonb;
    ...
    public void initJson()
    {
        JsonbConfig config = new JsonbConfig()
                .withAdapters(new WsOptionsAdapter());
    ...
    public void shouldReadOptions()
    {
        ...
        WsOptions options = jsonb.fromJson(text, WsOptions.class);
    ...
    {
        WsOptions options = new WsOptions("echo", null, "example.net:443", null);
